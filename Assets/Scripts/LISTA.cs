/*
Crear les animacions d’idle, córrer, saltar,  atacar i atacar en moviment --> FET

Crear l’Animator i afegir-hi les animacions --> FET

Crear el GameManager --> FET

Crear el SoundManager-- FET
...
opcional 1 sistema de curacio. --> FET

opcional 2 animacio de atac estatic bloqueja el moviment del personatge.
*/

/*
Efectes de so:

Recollir monedes --> FET

Recollir estrelles --> FET

Recollir cors --> FET

So de salt

So d’atac del jugador
...
Una per a l’escena de joc --> FET

Una altra per al Game Over
*/